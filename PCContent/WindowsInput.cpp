...
bool WindowsMouse::firstMouse = true;
float WindowsMouse::lastX = WINDOW_WIDTH / 2.f;
float WindowsMouse::lastY = WINDOW_HEIGHT / 2.f;
...
glm::vec2 WindowsMouse::GetPosition(bool value) const
{
	if (value)
	{
...
void WindowsMouse::MouseCallback(GLFWwindow* window, double xposIn, double yposIn)
{
	if (window != nullptr)
	{
